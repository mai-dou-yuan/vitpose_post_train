...
from experiments_graphormer_freihand_light_fastvit import pl_system_v6_graphormer as graphormer
...
def build_model(lightning_wrapper=False, **model_kwargs):
    model_class = FreiHANDPoseLightningModule if lightning_wrapper else graphormer.PoseLightningModule
